...
/** Parada física de la red. Nodo del grafo de rutas. */
public class Paradero {
    ...
    public String toCSV() { return id + ";" + nombre + ";" + barrio; }

    @Override public String toString() { return nombre + " (" + barrio + ")"; }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof Paradero)) return false;
        return id.equalsIgnoreCase(((Paradero) o).id);
    }
    @Override public int hashCode() { return id.toUpperCase().hashCode(); }
}